...
class CADTrack(BaseTracker):
    _sequence_id_counter = 0
    def __init__(self, params):
        super(CADTrack, self).__init__(params)
        network = build_cadtrack(params.cfg, training=False)
        ...
        self.z_dict1 = {}
        self.sequence_id = CADTrack._sequence_id_counter
        CADTrack._sequence_id_counter += 1
